...
INSERT INTO `SmModuleColumn`
    (`SmModuleId`,`Title`,`DataIndex`,`ValueType`,`Width`,`HideInTable`,`Sorter`,`filters`,`filterMultiple`,`IsExport`,`TaxisNo`,`IsLovCode`,`IsBool`,`QueryValue`,`QueryValueType`,`HideInSearch`,`DataFormate`,`Align`,`TableAlias`,`IsSum`,`FromTaxisNo`,`DefaultValue`,`HideInForm`,`Required`,`Disabled`,`Validator`,`ValidPattern`,`IsUnique`,`MaxLength`,`MinLength`,`Maximum`,`Minimum`,`CreateHide`,`ModifyDisabled`,`GridSpan`,`FormTitle`,`FieldType`,`Placeholder`,`DataSourceType`,`DataSource`,`IsMasterId`,`LabelCol`,`WrapperCol`,`MinRows`,`Remark`,`FromFieldGroup`,`IsTableEditable`,`IsAutoCode`,`ColumnMode`,`IsCopy`,`IsTooltip`,`TooltipContent`,`Color`,`IsThemeColor`,`AllowClear`,`IsMultiple`,`MultipleMaxCount`,`IsRedirect`,`RedirectUrl`,`ModifyHide`,`Accept`,`MaxFileSize`,`IsDeleted`,`IsActive`,`ImportDataId`,`ModificationNum`,`Tag`,`GroupId`,`CompanyId`,`AuditStatus`,`CurrentNode`,`CreatedBy`,`CreatedTime`,`ID`)
VALUES
