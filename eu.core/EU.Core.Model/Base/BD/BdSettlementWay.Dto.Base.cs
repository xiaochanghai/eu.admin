...
public class BdSettlementWayBase : BasePoco
{
    ...
    /// </summary>
    [Display(Name = "SettlementAccountType"), Description("账款类型, 现付-ImmediatePay;月结-MonthlyPay;次月结-NextMonthlyPay;货到付款-PayOnDelivery;其他-Other"), MaxLength(32, ErrorMessage = "账款类型, 现付-ImmediatePay;月结-MonthlyPay;次月结-NextMonthlyPay;货到付款-PayOnDelivery;其他-Other 不能超过 32 个字符")]
    public string SettlementAccountType { get; set; }

    /// <summary>
    /// 账期天数
    /// </summary>
    [Display(Name = "Days"), Description("账期天数")]
