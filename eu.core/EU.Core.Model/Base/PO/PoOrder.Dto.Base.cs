...
public class PoOrderBase : BasePoco
{
    ...
    /// 采购日期
    /// </summary>
    [Display(Name = "OrderDate"), Description("采购日期")]
    public DateTime? OrderDate { get; set; }

    /// <summary>
    /// 送达日期
    /// </summary>
    [Display(Name = "DeliveryDate"), Description("送达日期")]
    public DateTime? DeliveryDate { get; set; }

    /// <summary>
    /// 采购员ID
    /// </summary>
    [Display(Name = "UserId"), Description("采购员ID")]
    ...
    /// 结算方式
    /// </summary>
    [Display(Name = "SettlementWayId"), Description("结算方式")]
