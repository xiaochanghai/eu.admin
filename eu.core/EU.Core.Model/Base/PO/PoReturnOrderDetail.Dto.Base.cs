...
* Ver    变更日期 负责人  变更内容
* ───────────────────────────────────
* V0.01  2025/2/27 9:12:23  SimonHsiao   初版
*
...
/// 采购退货单明细 (Dto.Base)
/// </summary>
public class PoReturnOrderDetailBase : BasePoco
{
    ...
    /// 单据来源
    /// </summary>
    [Display(Name = "OrderSource"), Description("单据来源"), MaxLength(32, ErrorMessage = "单据来源 不能超过 32 个字符"), SugarColumn(IsNullable = true)]
    ...
    /// 退货数量
    /// </summary>
    [Display(Name = "QTY"), Description("退货数量"), Column(TypeName = "decimal(20,8)"), SugarColumn(IsNullable = true)]
