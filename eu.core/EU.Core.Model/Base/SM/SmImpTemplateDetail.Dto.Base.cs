...
public class SmImpTemplateDetailBase : BasePoco
{
    ...
    /// 模板ID
    /// </summary>
    [Display(Name = "ImpTemplateId"), Description("模板ID")]
    ...
    /// 是否插入
    /// </summary>
    [Display(Name = "IsInsert"), Description("是否插入")]
    ...
    /// 允许为空
    /// </summary>
    [Display(Name = "IsAllowNull"), Description("允许为空")]
    public bool? IsAllowNull { get; set; }

    /// <summary>
    /// 加密
    /// </summary>
    [Display(Name = "IsEncrypt"), Description("加密")]
