...
* Ver    变更日期 负责人  变更内容
* ───────────────────────────────────
* V0.01  2025/2/27 9:25:55  SimonHsiao   初版
*
...
public class SmConfigGroupBase : BasePoco
{
    ...
    /// 名称
    /// </summary>
    [Display(Name = "Name"), Description("名称"), MaxLength(32, ErrorMessage = "名称 不能超过 32 个字符"), SugarColumn(IsNullable = true)]
    public string Name { get; set; }

    /// <summary>
    /// 类型
    /// </summary>
    [Display(Name = "Type"), Description("类型"), MaxLength(32, ErrorMessage = "类型 不能超过 32 个字符"), SugarColumn(IsNullable = true)]
