...
/// <summary>
/// 平台共享模型配置，API 密钥仅以密文持久化。 (Dto.Base)
/// </summary>
public class AgModelConfigBase : BasePoco
{

    /// <summary>
    /// 不可变的公开模型配置标识，区分大小写且唯一，供 Agent 引用。
    /// </summary>
    [Display(Name = "ProfileCode"), Description("不可变的公开模型配置标识，区分大小写且唯一，供 Agent 引用。"), MaxLength(200, ErrorMessage = "不可变的公开模型配置标识，区分大小写且唯一，供 Agent 引用。 不能超过 200 个字符")]
    public string ProfileCode { get; set; }

    /// <summary>
    /// 模型配置在管理页面显示的名称。
    /// </summary>
    [Display(Name = "DisplayName"), Description("模型配置在管理页面显示的名称。"), MaxLength(200, ErrorMessage = "模型配置在管理页面显示的名称。 不能超过 200 个字符")]
    public string DisplayName { get; set; }

    /// <summary>
    /// 模型协议提供商，目前仅支持 OpenAICompatible。
    /// </summary>
    [Display(Name = "Provider"), Description("模型协议提供商，目前仅支持 OpenAICompatible。"), MaxLength(32, ErrorMessage = "模型协议提供商，目前仅支持 OpenAICompatible。 不能超过 32 个字符")]
    public string Provider { get; set; }

    /// <summary>
    /// 经部署白名单校验的 HTTPS 模型服务基础地址。
    /// </summary>
    [Display(Name = "Endpoint"), Description("经部署白名单校验的 HTTPS 模型服务基础地址。"), MaxLength(512, ErrorMessage = "经部署白名单校验的 HTTPS 模型服务基础地址。 不能超过 512 个字符")]
    public string Endpoint { get; set; }

    /// <summary>
    /// 供应商实际模型名称，可以不同于公开模型配置标识。
    /// </summary>
    [Display(Name = "ModelName"), Description("供应商实际模型名称，可以不同于公开模型配置标识。"), MaxLength(200, ErrorMessage = "供应商实际模型名称，可以不同于公开模型配置标识。 不能超过 200 个字符")]
    ...
    /// </summary>
    [Display(Name = "EnableThinking"), Description("Qwen 思考开关；1 开启，0 关闭，NULL 使用供应商默认。")]
