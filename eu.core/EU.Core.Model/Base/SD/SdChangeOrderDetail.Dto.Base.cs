...
/// 销售变更单明细 (Dto.Base)
/// </summary>
public class SdChangeOrderDetailBase : BasePoco
{
    ...
    /// 交货日期
    /// </summary>
    [Display(Name = "DeliveryDate"), Description("交货日期")]
    ...
    /// 结清人ID
    /// </summary>
    [Display(Name = "CloseUserId"), Description("结清人ID")]
    public Guid? CloseUserId { get; set; }

    /// <summary>
    /// 结清时间
    /// </summary>
    [Display(Name = "CloseTime"), Description("结清时间")]
