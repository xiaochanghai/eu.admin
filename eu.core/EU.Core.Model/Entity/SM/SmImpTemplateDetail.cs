...
/// 导入模板定义明细 (Model)
/// </summary>
[SugarTable("SmImpTemplateDetail", "导入模板定义明细"), Entity(TableCnName = "导入模板定义明细", TableName = "SmImpTemplateDetail")]
public class SmImpTemplateDetail : BasePoco
{
    ...
    /// 格式
    /// </summary>
    [Display(Name = "DateFormate"), Description("格式"), SugarColumn(IsNullable = true, Length = 32)]
    ...
    /// 参数代码
    /// </summary>
    [Display(Name = "LovCode"), Description("参数代码"), SugarColumn(IsNullable = true, Length = 32)]
    public string LovCode { get; set; }

    /// <summary>
    /// 映射表
    /// </summary>
    [Display(Name = "CorresTableCode"), Description("映射表"), SugarColumn(IsNullable = true, Length = 32)]
    public string CorresTableCode { get; set; }

    /// <summary>
    /// 映射字段
    /// </summary>
    [Display(Name = "CorresColumnCode"), Description("映射字段"), SugarColumn(IsNullable = true, Length = 32)]
    public string CorresColumnCode { get; set; }

    /// <summary>
    /// 转换字段
    /// </summary>
    [Display(Name = "TransColumnCode"), Description("转换字段"), SugarColumn(IsNullable = true, Length = 32)]
