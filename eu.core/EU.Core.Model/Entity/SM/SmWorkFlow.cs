...
* Ver    变更日期 负责人  变更内容
* ───────────────────────────────────
* V0.01  2025/11/15 21:58:59  SahHsiao   初版
*
...
public class SmWorkFlow : BasePoco
{
    ...
    /// </summary>
    [Display(Name = "FlowJson"), Description("已发布的流程节点JSON"), SugarColumn(IsNullable = true, ColumnDataType = "text")]
    public string FlowJson { get; set; }

    /// <summary>
    /// 未发布的草稿 JSON（设计器实时保存，发布后清空）
    /// </summary>
    [Display(Name = "DraftJson"), Description("未发布的草稿JSON"), SugarColumn(IsNullable = true, ColumnDataType = "text")]
