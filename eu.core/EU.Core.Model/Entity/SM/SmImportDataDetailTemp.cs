...
/// 系统导入数据明细临时表 (Model)
/// </summary>
[SugarTable("SmImportDataDetailTemp", "系统导入数据明细临时表"), Entity(TableCnName = "系统导入数据明细临时表", TableName = "SmImportDataDetailTemp")]
public class SmImportDataDetailTemp : BasePoco
{
