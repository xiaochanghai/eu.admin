...
public class SmModuleColumn : BasePoco
{
    ...
    /// 表单排序号
    /// </summary>
    [Display(Name = "FormTaxisNo"), Description("表单排序号"), SugarColumn(IsNullable = true)]
    ...
    /// 修改时隐藏
    /// </summary>
    [Display(Name = "ModifyHide"), Description("修改时隐藏"), SugarColumn(IsNullable = true)]
    public bool? ModifyHide { get; set; }

    /// <summary>
    /// 接受的文件类型
    /// </summary>
    [Display(Name = "Accept"), Description("接受的文件类型"), SugarColumn(IsNullable = true, Length = 64)]
    public string Accept { get; set; }

    /// <summary>
    /// 最大文件大小 (MB)
    /// </summary>
    [Display(Name = "MaxFileSize"), Description("最大文件大小 (MB)"), SugarColumn(IsNullable = true)]
