...
* Ver    变更日期 负责人  变更内容
* ───────────────────────────────────
* V0.01  2025/2/27 9:15:01  SimonHsiao   初版
*
...
public class SdShipOrderDetail : BasePoco
{
    ...
    /// 发货数量
    /// </summary>
    [Display(Name = "ShipQTY"), Description("发货数量"), Column(TypeName = "decimal(20,8)"), SugarColumn(IsNullable = true)]
    public decimal? ShipQTY { get; set; }

    /// <summary>
    /// 未发数量
    /// </summary>
    [Display(Name = "OutQTY"), Description("未发数量"), Column(TypeName = "decimal(20,8)"), SugarColumn(IsNullable = true)]
