...
* Ver    变更日期 负责人  变更内容
* ───────────────────────────────────
* V0.01  2025/2/27 9:01:33  SimonHsiao   初版
*
...
/// 库存建帐明细 (Model)
/// </summary>
[SugarTable("IvAccountingDetail", "库存建帐明细"), Entity(TableCnName = "库存建帐明细", TableName = "IvAccountingDetail")]
public class IvAccountingDetail : BasePoco
{
    ...
    /// 初始化时间
    /// </summary>
    [Display(Name = "InitTime"), Description("初始化时间"), SugarColumn(IsNullable = true)]
