...
* Ver    变更日期 负责人  变更内容
* ───────────────────────────────────
* V0.01  2025/2/27 9:01:41  SimonHsiao   初版
*
...
/// 库存出库单明细 (Model)
/// </summary>
[SugarTable("IvOutDetail", "库存出库单明细"), Entity(TableCnName = "库存出库单明细", TableName = "IvOutDetail")]
public class IvOutDetail : BasePoco
{
    ...
    /// 批次号
    /// </summary>
    [Display(Name = "BatchNo"), Description("批次号"), MaxLength(32, ErrorMessage = "批次号 不能超过 32 个字符"), SugarColumn(IsNullable = true)]
