...
namespace EU.Core.Model.Models
{
    ...
    /// <summary>
    /// PsProcessBadReason (Model)
    /// </summary>
    [SugarTable("PsProcessBadReason", "PsProcessBadReason"), Entity(TableCnName = "PsProcessBadReason", TableName = "PsProcessBadReason")]
    public class PsProcessBadReason : BasePoco
    {
