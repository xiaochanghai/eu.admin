...
namespace EU.Core.Model.Models
{
    ...
    /// <summary>
    /// PsProcessMachine (Model)
    /// </summary>
    [SugarTable("PsProcessMachine", "PsProcessMachine"), Entity(TableCnName = "PsProcessMachine", TableName = "PsProcessMachine")]
    public class PsProcessMachine : BasePoco
    {
