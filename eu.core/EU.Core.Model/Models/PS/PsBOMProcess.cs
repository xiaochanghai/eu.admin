...
* Ver    变更日期 负责人  变更内容
* ───────────────────────────────────
*V0.01  2024/5/6 14:58:23  SimonHsiao   初版
*
...
namespace EU.Core.Model.Models
{
    ...
    /// PsBOMProcess (Model)
    /// </summary>
    [SugarTable("PsBOMProcess", "PsBOMProcess"), Entity(TableCnName = "PsBOMProcess", TableName = "PsBOMProcess")]
    public class PsBOMProcess : BasePoco
    {
        ...
        /// 工艺不良率（%），百分比数据
        /// </summary>
        [Display(Name = "RejectRate"), Description("工艺不良率（%），百分比数据"), Column(TypeName = "decimal(20,2)")]
