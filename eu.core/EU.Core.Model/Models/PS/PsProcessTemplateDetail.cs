...
namespace EU.Core.Model.Models
{
    ...
    /// <summary>
    /// PsProcessTemplateDetail (Model)
    /// </summary>
    [SugarTable("PsProcessTemplateDetail", "PsProcessTemplateDetail"), Entity(TableCnName = "PsProcessTemplateDetail", TableName = "PsProcessTemplateDetail")]
    public class PsProcessTemplateDetail : BasePoco
    {
