...
namespace EU.Core.Model.Models
{
    ...
    /// <summary>
    /// PsProcessPrice (Model)
    /// </summary>
    [SugarTable("PsProcessPrice", "PsProcessPrice"), Entity(TableCnName = "PsProcessPrice", TableName = "PsProcessPrice")]
    public class PsProcessPrice : BasePoco
    {
