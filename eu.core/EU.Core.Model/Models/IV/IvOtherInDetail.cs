...
* Ver    变更日期 负责人  变更内容
* ───────────────────────────────────
*V0.01  2024/5/6 13:43:03  SimonHsiao   初版
*
...
namespace EU.Core.Model.Models
{
    ...
    /// 其他入库单明细 (Model)
    /// </summary>
    [SugarTable("IvOtherInDetail", "IvOtherInDetail"), Entity(TableCnName = "其他入库单明细", TableName = "IvOtherInDetail")]
    public class IvOtherInDetail : BasePoco
    {
