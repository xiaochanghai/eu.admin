...
* Ver    变更日期 负责人  变更内容
* ───────────────────────────────────
*V0.01  2024/4/26 17:38:09  SimonHsiao   初版
*
...
namespace EU.Core.Model.Models
{
    ...
    /// 应付对应发票 (Model)
    /// </summary>
    [SugarTable("ApInvoiceAssociation", "ApInvoiceAssociation"), Entity(TableCnName = "应付对应发票", TableName = "ApInvoiceAssociation")]
    public class ApInvoiceAssociation : BasePoco
    {
