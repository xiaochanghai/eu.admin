...
* Ver    变更日期 负责人  变更内容
* ───────────────────────────────────
*V0.01  2024/4/26 17:41:03  SimonHsiao   初版
*
...
namespace EU.Core.Model.Models
{
    ...
    /// 应付发票单明细 (Model)
    /// </summary>
    [SugarTable("ApInvoiceDetail", "ApInvoiceDetail"), Entity(TableCnName = "应付发票单明细", TableName = "ApInvoiceDetail")]
    public class ApInvoiceDetail : BasePoco
    {
