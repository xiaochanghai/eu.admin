...
* Ver    变更日期 负责人  变更内容
* ───────────────────────────────────
*V0.01  2024/4/26 14:25:13  SimonHsiao   初版
*
...
namespace EU.Core.Model.Models
{
    ...
    /// 应付对账单 (Model)
    /// </summary>
    [SugarTable("ApCheckOrder", "ApCheckOrder"), Entity(TableCnName = "应付对账单", TableName = "ApCheckOrder")]
    public class ApCheckOrder : BasePoco
    {
