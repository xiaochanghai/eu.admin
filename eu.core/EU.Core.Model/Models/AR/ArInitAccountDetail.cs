...
* Ver    变更日期 负责人  变更内容
* ───────────────────────────────────
*V0.01  2024/4/30 18:14:18  SimonHsiao   初版
*
...
namespace EU.Core.Model.Models
{
    ...
    /// 应收期初建账明细 (Model)
    /// </summary>
    [SugarTable("ArInitAccountDetail", "ArInitAccountDetail"), Entity(TableCnName = "应收期初建账明细", TableName = "ArInitAccountDetail")]
    public class ArInitAccountDetail : BasePoco
    {
