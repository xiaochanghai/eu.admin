...
* Ver    变更日期 负责人  变更内容
* ───────────────────────────────────
*V0.01  2024/5/6 10:55:14  SimonHsiao   初版
*
...
namespace EU.Core.Model.Models
{
    ...
    /// 应收开票明细 (Model)
    /// </summary>
    [SugarTable("ArInvoiceDetail", "ArInvoiceDetail"), Entity(TableCnName = "应收开票明细", TableName = "ArInvoiceDetail")]
    public class ArInvoiceDetail : BasePoco
    {
        ...
        /// 来源单编号
        /// </summary>
        [Display(Name = "SourceOrderNo"), Description("来源单编号"), MaxLength(32, ErrorMessage = "来源单编号 不能超过 32 个字符")]
        public string SourceOrderNo { get; set; }

        /// <summary>
        /// 销售单ID
        /// </summary>
        [Display(Name = "SalesOrderId"), Description("销售单ID"), MaxLength(32, ErrorMessage = "销售单ID 不能超过 32 个字符")]
        public string SalesOrderId { get; set; }

        /// <summary>
        /// 销售单编号
        /// </summary>
        [Display(Name = "SalesOrderNo"), Description("销售单编号"), MaxLength(32, ErrorMessage = "销售单编号 不能超过 32 个字符")]
        ...
        /// 客户物料名称
        /// </summary>
        [Display(Name = "CustomerMaterialName"), Description("客户物料名称"), MaxLength(64, ErrorMessage = "客户物料名称 不能超过 64 个字符")]
