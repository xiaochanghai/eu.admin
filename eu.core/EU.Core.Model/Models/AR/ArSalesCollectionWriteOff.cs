...
namespace EU.Core.Model.Models
{
    ...
    /// 销售收款核销明细 (Model)
    /// </summary>
    [SugarTable("ArSalesCollectionWriteOff", "ArSalesCollectionWriteOff"), Entity(TableCnName = "销售收款核销明细", TableName = "ArSalesCollectionWriteOff")]
    public class ArSalesCollectionWriteOff : BasePoco
    {
