...
/// 结算方式 (Model)
/// </summary>
[SugarTable("BdSettlementWay", "BdSettlementWay"), Entity(TableCnName = "结算方式", TableName = "BdSettlementWay")]
public class BdSettlementWay : BasePoco
{
    ...
    /// 账款类型,  
    /// </summary>
    [Display(Name = "SettlementAccountType"), Description("账款类型 "), MaxLength(32, ErrorMessage = "账款类型 不能超过 32 个字符")]
