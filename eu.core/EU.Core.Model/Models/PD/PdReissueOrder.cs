...
namespace EU.Core.Model.Models
{
    ...
    /// <summary>
    /// PdReissueOrder (Model)
    /// </summary>
    [SugarTable("PdReissueOrder", "PdReissueOrder"), Entity(TableCnName = "PdReissueOrder", TableName = "PdReissueOrder")]
    public class PdReissueOrder : BasePoco
    {
