...
namespace EU.Core.Model.Models
{
    ...
    /// <summary>
    /// PdRequireAnalysis (Model)
    /// </summary>
    [SugarTable("PdRequireAnalysis", "PdRequireAnalysis"), Entity(TableCnName = "PdRequireAnalysis", TableName = "PdRequireAnalysis")]
    public class PdRequireAnalysis : BasePoco
    {
