...
* Ver    变更日期 负责人  变更内容
* ───────────────────────────────────
*V1.0  2024/5/6 11:10:40  SimonHsiao   初版
*
...
public class ArPrepaidOrderController : BaseController1<ArPrepaidOrder>
{
    ...
    public IActionResult AuditOrder(dynamic modelModify)
    {
        ...
        try
        {
            ...
            #region 导入订单操作历史
            Utility.RecordOperateLog(UserId.ToString(), "PD_ORDER_MNG", "ArPrepaidOrder", orderId, OperateType.Update, "Audit", "修改订单审核状态为：" + auditStatus);
            #endregion
