...
* Ver    变更日期 负责人  变更内容
* ───────────────────────────────────
*V1.0  2024/5/6 14:40:04  SimonHsiao   初版
*
...
public class PdReturnOrderController : BaseController1<PdReturnOrder>
{
    ...
    public IActionResult AuditOrder(dynamic modelModify)
    {
        ...
        try
        {
            ...
            #region 导入订单操作历史
            Utility.RecordOperateLog(User.Identity.Name, "PO_ARRIVAL_ORDER_MNG", "PdReturnOrder", orderId, OperateType.Update, "Audit", "修改订单审核状态为：" + auditStatus);
            #endregion
    ...
    public IActionResult ConfirmReturn(Guid Id)
    {
        ...
        try
        {
            ...
            #region 导入订单操作历史
            Utility.RecordOperateLog(User.Identity.Name, "PD_OUT_ORDER_MNG", "PdReturnOrder ", Id.ToString(), OperateType.Update, "CompleteReturn", "修改订单审核状态为：CompleteReturn");
            #endregion
