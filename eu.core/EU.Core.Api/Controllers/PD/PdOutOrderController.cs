...
public class PdOutOrderController : BaseController1<PdOutOrder>
{
    ...
    public IActionResult AuditOrder(dynamic modelModify)
    {
        ...
        try
        {
            ...
            #region 导入订单操作历史
            Utility.RecordOperateLog(User.Identity.Name, "PO_ARRIVAL_ORDER_MNG", "PdOutOrder", orderId, OperateType.Update, "Audit", "修改订单审核状态为：" + auditStatus);
            #endregion
    ...
    public IActionResult ConfirmOut(Guid Id)
    {
        ...
        try
        {
            ...
            #region 导入订单操作历史
            Utility.RecordOperateLog(User.Identity.Name, "PD_OUT_ORDER_MNG", "PdOutOrder ", Id.ToString(), OperateType.Update, "CompleteOut", "修改订单审核状态为：CompleteOut");
            #endregion
