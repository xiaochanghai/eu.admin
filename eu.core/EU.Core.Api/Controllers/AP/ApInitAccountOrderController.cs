...
* Ver    变更日期 负责人  变更内容
* ───────────────────────────────────
*V1.0  2024/4/26 15:30:40  SimonHsiao   初版
*
...
public class ApInitAccountOrderController : BaseController1<ApInitAccountOrder>
{
    ...
    public override async Task<IActionResult> GetById(Guid Id)
    {
        ...
        try
        {
            ...
            BdSupplier supplier = await _context.BdSupplier.Where(O => O.ID == order.SupplierId).FirstOrDefaultAsync();
            if (supplier != null)
    ...
    public IActionResult AuditOrder(dynamic modelModify)
    {
        ...
        try
        {
            ...
            #region 导入订单操作历史
            Utility.RecordOperateLog(UserId.ToString(), "PD_ORDER_MNG", "ApInitAccountOrder", orderId, OperateType.Update, "Audit", "修改订单审核状态为：" + auditStatus);
            #endregion
