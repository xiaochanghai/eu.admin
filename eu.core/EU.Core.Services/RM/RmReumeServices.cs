...
public class RmReumeServices : BaseServices<RmReume, RmReumeDto, InsertRmReumeInput, EditRmReumeInput>, IRmReumeServices
{
    ...
    public async Task ReadPdfAttachmentsAsync()
    {
        ...
        {
            //
            //await client.ConnectAsync("imap.yeah.net", 993, true);
            //await client.AuthenticateAsync("simonhsiao@yeah.net", "rvEZ9Vz2Aox");

            //var imap = new ImapClient();

            //imap.Connect("imap-mail.outlook.com", 993, true);
            //imap.Authenticate("xiaochanghai@outlook.com", "Hsiao199227");
            ...
            //    //await client.AuthenticateAsync("he2025667@outlook.com", "Zh266566");
            //    //await client.AuthenticateAsync("he2025667@outlook.com", "hqtuzzbqjurbhejl");
            //await client.AuthenticateAsync("zjttsoft@outlook.com", "Cq300850");
    ...
    static ResumeInfo ExtractResumeInfo(string text)
    {
        ...
        // 手机号
        var phoneMatch = Regex.Match(text, @"1[3-9]\d{9}");
