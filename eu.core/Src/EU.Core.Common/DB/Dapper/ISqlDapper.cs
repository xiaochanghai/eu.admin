...
public interface ISqlDapper
{
    ...
    Task<List<T>> QueryListAsync<T>(string cmd, object param = null, CommandType? commandType = null, IDbTransaction transaction = null, int? commandTimeout = null) where T : class;
