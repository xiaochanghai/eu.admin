namespace EU.Core.Common.AppConfig;

public class AppSecretConfig
{
    private static string Audience_Secret = AppSettings.app(["Audience", "Secret"]);
    private static string Audience_Secret_File = AppSettings.app(["Audience", "SecretFile"]);
