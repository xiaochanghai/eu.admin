...
public class FrameSeed
{
    ...
    public static string GetCopyRight(string tableName)
    {
        ...
        build.Append("* ───────────────────────────────────\r\n");
        build.Append("* V1.0  " + DateTime.Now.ToString() + "  SahHsiao   初版\r\n");
        build.Append("*\r\n");
...
@"{SugarColumn}
        ...
        string sql = @"SELECT A.name AS table_name,
                                       ...
                                       D.NUMERIC_PRECISION, D.NUMERIC_SCALE,D.CHARACTER_MAXIMUM_LENGTH, D.COLUMN_DEFAULT, B.is_nullable
                                FROM sys.tables A
        ...
        for (int i = 0; i < dtColumn.Rows.Count; i++)
        {
            ...
            //build.Append("    [Display(Name = \"" + columnCode + "\"), Description(\"" + column_description + "\"), MaxLength(" + CHARACTER_MAXIMUM_LENGTH + ", ErrorMessage = \"" + column_description + " 不能超过 " + CHARACTER_MAXIMUM_LENGTH + " 个字符\"), SugarColumn(IsNullable = true, Length = 256)]\r\n");
                ...
                build.Append($"    [Display(Name = \"{columnCode}\"), Description(\"{column_description}\"){(IS_NULLABLE ? ", SugarColumn(IsNullable = true)" : null)}]\r\n");
        ...
        build.Append("*/ \r\n");
        build.Append("\r\n");
        build.Append("namespace EU.Core.Model.Insert;\r\n");
        //build.Append("{\r\n");
        build.Append("\r\n");
        build.Append("/// <summary>\r\n");
        ...
        build.Append("*/ \r\n");
        build.Append("\r\n");
        build.Append("namespace EU.Core.Model.Edit;\r\n");
        //build.Append("{\r\n");
        build.Append("\r\n");
        build.Append("/// <summary>\r\n");
