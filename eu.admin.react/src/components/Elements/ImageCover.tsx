 ...
 * @returns React组件
 */
const ImageCoverField: React.FC<ImageCoverFieldProps> = ({ field, disabled, modifyType = ModifyType.Edit, onChange }) => {
  ...
  return (
    ...
    >
      <ImageCover filePath="cover" imageType="cover" disabled={isDisabled} onChange={handleChange} />
    </FormItem>
  );
};

// 使用React.memo优化性能，避免不必要的重渲染
export default React.memo(ImageCoverField);
