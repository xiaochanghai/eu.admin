...
const EditableCell: React.FC<EditableCellProps> = ({
  ...
  if (editable) {
    childNode = editing ? (
      ...
      >
        <Input ref={inputRef as unknown as () => RefObject<HTMLInputElement>} onPressEnter={save} onBlur={save} />
      </Form.Item>
    ) : (
...
class EditableTable extends React.Component<any, any> {
  ...
  constructor(props: any) {
    ...
    const dataSource = props.value && props.value.map((item: any, i: number) => ({ key: i + "", ...item }));
    ...
    return (
      <>
        ...
        <Modal
          ...
          cancelText="取消"
        >
          <Button type="primary" onClick={this.handleAdd} style={{ marginBottom: 16, marginRight: 16 }}>
            添加行
          </Button>
          <Upload {...props}>
