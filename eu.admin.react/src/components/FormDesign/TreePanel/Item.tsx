...
import { moveCom, setFocus, FieldNodeSchema } from "@/redux/modules/formDesign";
  ...
  return (
    <li onClick={handleFocus} ref={ref}>
      ...
      >
        ...
        {data.children && (
          <ul
            className={cl("ml-2 border-l border-gray-200 pl-2  ease-in duration-300 transition-all", {
