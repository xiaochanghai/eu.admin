...
export const materialUis: IMaterialUIs = {
  ...
  [NodeType.approver]: {
    ...
    viewContent: (node: IWorkFlowNode<IApproverSettings>, { t }) => {
      return <ContentPlaceholder node={node} secondary text={t("pleaseChooseApprover")} />;
    },
    //属性面板
  ...
  [NodeType.audit]: {
    //节点内容区
    viewContent: (node: IWorkFlowNode<IApproverSettings>, { t }) => {
      return <ContentPlaceholder node={node} secondary text={t("pleaseChooseDealer")} />;
    },
    //属性面板
  ...
  [NodeType.notifier]: {
    viewContent: (node: IWorkFlowNode<IApproverSettings>, { t }) => {
      return <ContentPlaceholder node={node} text={t("pleaseChooseNotifier")} />;
    },
