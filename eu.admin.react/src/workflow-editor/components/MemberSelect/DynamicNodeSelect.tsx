import SwitchCard from "@/components/checkbox/SwitchCard";
import { VfBaseProps } from "@/dsl/component";
import { NodeUserInfo } from "@/workflow-editor/classes/vlife";
import { useCallback } from "react";
/**
 * 动态节点选择
 */
export interface DynamicNodeSelectProps extends VfBaseProps<Partial<NodeUserInfo>[]> {}
export default ({ onDataChange, className, value }: DynamicNodeSelectProps) => {
  ...
  return (
    <div className={`${className}`}>
      <SwitchCard
        title={"申请人"}
        iconNode={<i className=" text-blue-400 text-3xl  icon-account_circle" />}
