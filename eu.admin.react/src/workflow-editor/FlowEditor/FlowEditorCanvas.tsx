...
//dlc 工作流编辑器画布
export const FlowEditorCanvas = memo((props: { className?: string; style?: CSSProperties; form?: FormVo }) => {
  ...
  return (
    ...
    <CanvasContainer {...props}>
      ...
      {/* 放大缩小 */}
      <ZoomBar float={scrolled} zoom={zoom} onZoomIn={haneldZoomIn} onZoomOut={haneldZoomOut} />
      {/* 右侧配置面板 */}
