...
const Index: React.FC<any> = () => {
  ...
  const InventoryInPosting = async (_action: any, _selectedRows: any, selectedRowKeys: any) => {
    ...
    confirm({
      ...
      async onOk() {
        ...
        let { Success } = await http.post<any>("/api/IvIn/Posting", selectedRowKeys);
        message.destroy();
        if (Success) {
  ...
  const action = { InventoryInPosting };
