...
import { EditableProTable, FormToolbar, renderFormComponent, Skeleton } from "@/components";
    ...
    <>
      ...
      <WaitSelect
        ...
        onSubmit={async (values: any) => {
          message.loading("数据提交中...", 0);
          let { Success, Message } = await http.post<any>("/api/PoArrivalOrder/BulkInsertDetail/" + id, values);
          message.destroy();
          if (Success) {
            message.success(Message);
            querySingleData();
