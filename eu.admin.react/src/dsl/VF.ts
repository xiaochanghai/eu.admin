...
export class VfAction {
  ...
  selected(): VfAction {
    this.reations.push({
      state: FS_STATE["x-decorator-props"],
      value: {
        style: {
...
export class VF {
   ...
   * @returns
   */
  static result(result: whenResult): VF {
    const obj = new VF("");
    obj.result = result;
    obj.conn = "and";
    return obj;
